...
# load data
################
study2canada <- xlsx::read.xlsx2(file = "study2canada_indicatorsCAMs_long.xlsx", sheetIndex = 1)
study2germany <- xlsx::read.xlsx2(file = "study2germany_indicatorsCAMs_long.xlsx", sheetIndex = 1)
study3 <- xlsx::read.xlsx2(file = "study3_indicatorsCAMs_long.xlsx", sheetIndex = 1)
